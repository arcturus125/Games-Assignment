...
void AEnemyCharacter::BeginPlay()
{
	...
	if (bb != nullptr) {
		...
		{
			bb->SetValueAsVector(TEXT("LookoutPosition"), lookoutPoint->GetActorLocation());
		}
		else UE_LOG(LogTemp, Warning, TEXT("lookout point nullptr"));

		if (homePoint != nullptr)
		{
			bb->SetValueAsVector(TEXT("HomePosition"), homePoint->GetActorLocation());
		}
		else UE_LOG(LogTemp, Warning, TEXT("home point nullptr"));
	}
	else UE_LOG(LogTemp, Warning, TEXT("bb nullptr"));
